...
class Database {
	...
	public function open_connection() {
		...
		if(!$this->conn){
			echo "Problem in database connection! " . mysqli_connect_error(); // Display specific connection error
			exit();
			...
			if (!$db_select) {
				echo "Problem in selecting database! " . mysqli_error($this->conn); // Display specific database selection error
				exit();
			}
		}
	...
	public function affected_rows() {
	 ...
	 public function escape_value( $value ) {
		// The magic_quotes_gpc function was removed in PHP 8.0.
		// mysqli_real_escape_string is the correct and modern way to escape values.
