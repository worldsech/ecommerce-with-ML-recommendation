        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >E-shop Admin Dashboard</a>
            </div>
            <!-- /.navbar-header -->
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        ...
                        <img title="profile image" width="23px" height="17px" src="<?php echo web_root.'admin/user/'. (isset($singleuser->USERIMAGE) && !empty($singleuser->USERIMAGE) ? $singleuser->USERIMAGE : 'photos/default.png'); ?>">  
                            
                    </a>
                    <ul class="dropdown-menu dropdown-acnt">
                          <div class="divpic"> 
                            <a href="" data-target="#usermodal"  data-toggle="modal" > 
                                <img title="profile image" width="70" height="80" src="<?php echo web_root.'admin/user/'. (isset($singleuser->USERIMAGE) && !empty($singleuser->USERIMAGE) ? $singleuser->USERIMAGE : 'photos/default.png'); ?>">
                            </a>
                          </div> 
                                ...
                                "post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="rows"> 
                                                    <img title="profile image" width="500" height="360" src="<?php echo web_root.'admin/user/'. (isset($singleuser->USERIMAGE) && !empty($singleuser->USERIMAGE) ? $singleuser->USERIMAGE : 'photos/default.png'); ?>">  
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; Rectem computer science HND project </p></footer>
</html>