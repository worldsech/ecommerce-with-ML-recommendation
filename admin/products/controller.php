...
switch ($action) {
    ...
    case 'removediscount' : // Added this case to handle removeDiscount action
        removeDiscount();
        break;
}
...
function doInsert(){
    ...
    function doEdit(){
        if (@$_GET['stats']=='NotAvailable'){
            ...
            message("Product Status has been updated to Available !","success");
            redirect("index.php");
            ...
            $product->update($_GET['id']);
                message("Product Status has been updated to NotAvailable !","success");
            redirect("index.php");
    ...
    } // This is the missing closing brace for setDiscount()
