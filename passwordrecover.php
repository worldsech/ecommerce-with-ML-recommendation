	...
	if (isset($_POST['recover-submit'])) {
		...
		$customer = New Customer();
          ...
          $_SESSION['recovery_code'] = $code;
	        ...
	        $sql = "INSERT INTO `messageout` (`Id`, `MessageTo`, `MessageFrom`, `MessageText`) VALUES (Null, '".$_SESSION['phonenumber']."','YourShop','".'Your code is ' .$_SESSION['recovery_code']."')";
	        $mydb->setQuery($sql);
	        $mydb->executeQuery();
	...
	if (isset($_POST['savepass-submit'])) {
		...
		$customer = New Customer();
      	...
      	if ($res) {
			...
			$customer = New Customer();   
			$customer->CUSPASS			= $_POST['newpassword'];	
