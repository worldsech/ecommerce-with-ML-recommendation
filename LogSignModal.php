                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <!-- <div class="panel-footer">
                             <p align="left">&copy; <a href="https://www.yourwebsite.com/">Your Company Name</a></p>
                        </div> -->
                    </div> 
                  </div>
                  <!-- end login panel -->
                      ...
                      <!-- <h4>Customer Details</h4>  --> 
                           ...
                           <form  class="form-horizontal span6" action="customer/controller.php?action=add" onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data">
                                <div class="panel panel-pup">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+234 811 731 1691" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of the E-shop</small>
                                    ...
                                    <div class="panel-footer">
                                        <p align="left">&copy; <a href="#">Debby's Source Code</a></p>
                                    </div> 
                            </div> 
                            <!-- end panel sign up -->
                        </form>  
