...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +234 811 7311 691</a></li>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              ...
              <p>Bringing shopping to you even when you are not sure of what you are looking for.</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <!-- <p class="pull-left">Modified by <span><a href="#">Your Name Here</a></span></p> -->
          <p class="pull-right">Designed by <span>Ogunyemi Deborah</span></p>
        </div>
      </div>
    </div>
